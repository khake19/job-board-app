...
export default function JobCard({ job }: JobCardProps) {
  ...
  return (
    <div className="w-full shadow-md rounded p-4 pt-2 mt-8 bg-white relative lg:flex lg:items-center lg:justify-between lg:p-6">
  {/* Logo */}
  ...
  {/* Main content wrapper: info + tags */}
